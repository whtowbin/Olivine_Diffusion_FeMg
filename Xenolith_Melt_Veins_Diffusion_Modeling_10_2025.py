...
Ol_MP_overgrowth = Ol_Data.loc[
    (Ol_Data.Category == "Melt Pocket Overgrowth")
    & (Ol_Data.Profile == "yes")
    & (Ol_Data.Marked_bad != "bad")
    & (Ol_Data.Ignore != "yes")
]
...
Ol_exterior = Ol_Data.loc[
    (Ol_Data.Category == "exterior")
    & (Ol_Data.Profile == "yes")
    & (Ol_Data.Marked_bad != "bad")
    & (Ol_Data.Ignore != "yes")
]

Ol_phenocrysts = Ol_Data.loc[
    (Ol_Data.Category == "Phenocryst")
    & (Ol_Data.Profile == "yes")
    & (Ol_Data.Marked_bad != "bad")
    & (Ol_Data.Ignore != "yes")
]
...
# %%
# Original
# Exterior_Names = Ol_exterior.Comment.unique()
# MP_overgrowth_Names = Ol_MP_overgrowth.Comment.unique()
# Phenocrysts_Names = Ol_phenocrysts.Comment.unique()
#
Exterior_Names = Ol_exterior.Profile_Name.unique()
MP_overgrowth_Names = Ol_MP_overgrowth.Profile_Name.unique()
Phenocrysts_Names = Ol_phenocrysts.Profile_Name.unique()
#
# Category = Ol_profiles.Category.unique()
# %%
...
#%%
def plot_diffusion_results(Model_dict, ax=None):
    if ax is None:
        ax = plt.gca()
    ax.plot(
        Model_dict["x"],
...
#%%
sample_name = "AZ18 WHT01_bigol1_overgrowth_prof_1"  #
# sample_name = "AZ18 WHT01_Ol_180_prof_1"
# sample_name = "AZ18 WHT01_Ol_181_prof_2"
# sample_name = "Xenocryst_ol23_prof_1"
# sample_name =  "AZ18 WHT01_Ol_191_prof_1"
...
plot_diffusion_results(Model_dict, ax=ax)
...
for idx, sample in enumerate(files_to_model):
    try:
        Model_dict = model_diffusion(sample)
