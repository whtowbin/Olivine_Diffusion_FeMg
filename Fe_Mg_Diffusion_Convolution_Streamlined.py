...
def step_condition(x_interp, inflection_points, Interval_concentrations, dx_micron):
...
def fo2buffer(T, P_pa, delta, buff):
...
def Diffusion_call(
    ...
    **kwargs
    ...
    step_c = step_condition(
        x_interp, inflection_points, Interval_concentrations, dx_micron
    )
